...
('Toronto',9),
('Madrid',10);
INSERT INTO factory( region_id, address, number_of_workers, phone_number) VALUES 
(1,'Truskawka 21', 34, 878726),
(2,'Dzierben 178', 38, 456735),
(1,'Gorodotska 234', 30, 101101),
(7,'Shevchenkivska 32', 24, 12221),
(6,'Dzen 453', 12, 2333424),
(5,'Sweet Rain 14', 23, 5535677),
(5,'Ren Ain 45', 50, 0090039),
(8,'Blue Air 78', 46, 982916),
(9,'Berden 93', 60, 001002003),
(3,'Schenen 166', 42, 889880);
